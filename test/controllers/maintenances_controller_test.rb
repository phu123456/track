...
class MaintenancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maintenance" do
    assert_difference('Maintenance.count') do
      post maintenances_url, params: { maintenance: { current_distance: @maintenance.current_distance, manually_distance: @maintenance.manually_distance, service_id: @maintenance.service_id, start_distance: @maintenance.start_distance, vehicle_id: @maintenance.vehicle_id } }
    end
  ...
  test "should update maintenance" do
    patch maintenance_url(@maintenance), params: { maintenance: { current_distance: @maintenance.current_distance, manually_distance: @maintenance.manually_distance, service_id: @maintenance.service_id, start_distance: @maintenance.start_distance, vehicle_id: @maintenance.vehicle_id } }
